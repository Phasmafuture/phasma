...
import type { UserRole as _UserRole, WorkspacePlan as _WorkspacePlan } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async adminGetUserWorkspacePlan(arg0: Principal): Promise<WorkspacePlan> {
        if (this.processError) {
            try {
                const result = await this.actor.adminGetUserWorkspacePlan(arg0);
                return from_candid_WorkspacePlan_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getCallerWorkspacePlan(): Promise<WorkspacePlan> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerWorkspacePlan();
                return from_candid_WorkspacePlan_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async selectWorkspacePlan(arg0: WorkspacePlan): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.selectWorkspacePlan(to_candid_WorkspacePlan_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_WorkspacePlan_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WorkspacePlan): WorkspacePlan {
...
function from_candid_variant_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pro" in value ? WorkspacePlan.pro : "free" in value ? WorkspacePlan.free : value;
}
...
function to_candid_WorkspacePlan_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: WorkspacePlan): _WorkspacePlan {
...
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: WorkspacePlan): {
    pro: null;
} | {
    free: null;
} {
    return value == WorkspacePlan.pro ? {
        pro: null
